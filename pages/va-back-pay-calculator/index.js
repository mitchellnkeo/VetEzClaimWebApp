...
export default function VABackPayCalculator() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 text-gray-900 transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100">
      ...
      <main className="relative flex flex-grow flex-col items-center px-4 py-12">
        {/* Top-right menu icon */}
        <button
          onClick={goToMenu}
          className="absolute left-4 top-4 rounded p-2 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:hover:bg-gray-700"
          aria-label="Open Calculator Menu"
        >
          <HiOutlineMenu className="h-6 w-6 text-gray-800 dark:text-gray-100" />
        </button>

        <h1 className="mb-3 text-center text-3xl font-bold">
          VA Back Pay Calculator
        </h1>
        <p className="mb-10 max-w-xl text-center text-gray-600 dark:text-gray-400">
...
{/* 
            ...
            {/* {compensationType === 'Disability Rating' && (
              <>
                ...
                <div className="mb-6 rounded border bg-gray-100 p-4 dark:border-0 dark:bg-gray-700">
                  <label className="text-md block  font-bold">
                    What was the benefit rate you were actually receiving on
                    this date?
                  </label>
                  <select
                    className="mt-2 w-full rounded border p-2 dark:border-gray-700 dark:bg-gray-900 dark:text-white-light"
