...
function SinglePage() {
  ...
  // console.log('fileAppealData', fileAppealData);
  // console.log('fillFormsData', fillFormsData);
  // console.log('requestFilesData', requestFilesData);
  // console.log('submitClaimsData', submitClaimsData);
          ...
          <Tab.Panel>
            <div className="pt-5">
              <div className="flex items-center gap-2 text-xl">
                ...
                {isLoading && <Loading />}
                {!isLoading && !error ? (
                  <FileAppealsDetails data={requestFilesData} />
                ) : null}
              </div>
            </div>
          </Tab.Panel>
