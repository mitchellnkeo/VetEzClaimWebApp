          ...
          return (
            ...
            >
              ...
              <Form>
                ...
                <SectionTitle title="Section II:  Patient Identification for Records VA Is Requesting" subtitle="(If other than veteran)" />
                <> 
                <Switch
                  name="isVeteran"
                    ...
                    {values.medicalProvider.map((item, ind) => {
                      return (
                        <div key={ind} className="mt-10">
                            <Divider title={`Medical Provider #${ ind + 1}` } lightTitle/>
                            <TextInput
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                        <DateSelectorExtended
                                            ...
                                            referenceDate={values.medicalProvider[ind].dateTreatmentTo}
                                            value={values.medicalProvider[ind].dateTreatmentFrom}
                                            placeholder="Select Date"
                                            onChange={(val) =>
                                                setFieldValue(`medicalProvider[${ind}].dateTreatmentFrom`, val)
                                            }
                                            isStartDate={true}
                                        />
                                        ...
                                        <DateSelectorExtended
                                            ...
                                            value={values.medicalProvider[ind].dateTreatmentTo}
                                            referenceDate={values.medicalProvider[ind].dateTreatmentFrom}
                                            placeholder="Select Date"
                                            onChange={(val) =>
                                                setFieldValue(`medicalProvider[${ind}].dateTreatmentTo`, val)
                                            }
                                            isStartDate={false}
                                        />
                                </div>
