...
const contactOption = [
    {
        option: 'Contact the veteran/claimant. If contact will be by phone, contact in the morning hours based on time zone.',
        isSelected: false,
        value: 'b8:12',
      },
      {
        option: 'Contact the veteran/claimant. If contact will be by phone, contact in the afternoon hours based on time zone.',
        isSelected: false,
        value: 'b12:4.30',
      },
      {
        option: 'Contact the representative. If contact will be by phone, contact in the morning hours based on time zone.',
        isSelected: false,
        value: 'rb8:12',
      },
      {
        option: 'Contact the representative. If contact will be by phone, contact in the afternoon hours based on time zone.',
        isSelected: false,  
        value: 'rb12:4.30',
      },
];
      ...
      >
        {({
          ...
          const transformFormValues = async (formData) => {
            return {
              ...formData,
              isInformalConference: formData.isInformalConference?.[0]?.isSelected || false,
          ...
          const generatePdf = async (formValues, isFromGeneratePdf = false) => {
            ...
            const pdfObject = await  generateHigherLevelReviewPdfObject(formData);
            ...
            >
              ...
              <Form>
                ...
                <>  
                    ...
                    <h6 className='my-5'>
                        If you would like VA to contact your representative, you must
                        provide your representative's contact information below.
                    </h6>
                ...
                <>
                    ...
                    associated hearing requests, and opting for the issues to be decided in the
                    modernized review system. You acknowledge you cannot return to the legacy
                    ...
                    For each issue, identify the date of VA's most recent decision on the issue in
                    Item 18B. If the space below is insufficient to include the information
                    regarding your issue(s), it is acceptable to indicate that in the space below
                    and attach additional pages to this form to complete your request. Include
                ...
                <> 
                    ...
                    Representative, or VA Form 21-22a, Appointment of Individual as Claimant's
                    Representative, indicating the appropriate representative is of record with VA
