...
export default function TDIUForm() {
  const formTitle =
    'Increased Rating due to TDIU (Unemployability) (Form 21-8940)';
            ...
            if (hasErrors) {
              ...
              await generatePdfService(pdfObject, 'generatepdf17')
                .then(async (res) => {
                  ...
                  const faxBody = await getFaxBodyData('tdiuform.pdf', false);
                  const faxData = {
                    ...faxBody,
              ...
              <Form>
                ...
                <>
                  <DateSelectorExtended
                    ...
                    placeholder="Select Date"
                    onChange={(val) =>
                      setFieldValue('dateFullTimeEmployment', val)
                    }
                  ...
                  <>
                    <div className="my-3 flex items-center justify-between">
                      ...
                      >
                        List all your employment including self-employment for
                            ...
                            <>
                              ...
                              <div className="grid grid-cols-2 gap-6">
                                <DateSelectorExtended
                                  ...
                                  referenceDate={
                                    values.employmentStatement[ind]
                                      .dateEmploymentTo
                                  }
                                  value={
                                    values.employmentStatement[ind]
                                  ...
                                  onChange={(val) =>
                                    setFieldValue(
                                      `employmentStatement[${ind}].dateEmploymentFrom`,
                                      val
                                    )
                                  }
                                  isStartDate={true}
                                ...
                                <DateSelectorExtended
                                  ...
                                  onChange={(val) =>
                                    setFieldValue(
                                      `employmentStatement[${ind}].dateEmploymentTo`,
                                      val
                                    )
                                  }
                                  isStartDate={false}
