...
export default function BuddyRequests() {
  ...
  const onView = async (request) => {
    ...
    if (
      request.status === 'witness_submitted' ||
              ...
              const onSendRequest = async () => {
                ...
                try {
                  ...
                  const response = await dispatch(
                    sendDocToWitness(sendData)
                  ).unwrap(); // success payload
                  ...
                  process.env.NODE_ENV === 'development' &&
                    console.error('Error sending request:', error);
                  toast.error(
                    'Failed to send email to witness. Please try again later.'
                  );
                } finally {
                  setIsLoading(false);
                }
  ...
  const completeFormModal = (
    <Modal
      open={openCompleteFormModal}
      onClose={() => setOpenCompleteFormModal(false)}
              ...
              <div className="p-1">
                <Form className="space-y-4">
                  ...
                  <>
                    ...
                    <TextInput label="Date of Birth" name="birthday" readOnly />
                    <TextInput
                  ...
                  <>
                    ...
                    <TextInput label="Date Signed" name="dateSigned" readOnly />
          ...
          <div className="invoice-table">
            ...
            <div className="flex w-full justify-center">
              <button
                ...
                className="flex cursor-pointer items-center gap-2 rounded-md bg-primary px-6 py-2 text-sm text-white hover:bg-primaryHover"
              >
