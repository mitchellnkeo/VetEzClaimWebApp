...
const condition1 =
  '10A. Direct Review by a Veterans Law Judge: I do not want a Board hearing, and will not submit any additional evidence in support of my appeal. (Choosing this option often results in the Board issuing its decision most quickly.)';
const condition2 =
  "10B. Evidence Submission Reviewed by a Veterans Law Judge: I have additional evidence in support of my appeal that I will submit to the Board with my VA Form 10182 or within the 90 days of the Board's receipt of my VA Form 10182. (Choosing this option will extend the time it takes for the Board to decide your appeal.)";
const condition3 =
  '10C. Hearing with a Veterans Law Judge: I want a Board hearing and the opportunity to submit additional evidence in support of my appeal that I will provide within 90 days after my hearing. I want the hearing type below: (Choosing this option will extend the time it takes for the Board to decide your appeal.)';

const specificIssue1 =
  'Check here if you are including a request for an extension of time to file the VA Form 10182 due to good cause and then attach additional sheets explaining why you believe there is good cause for the extension.';
const specificIssue2 =
  'Check here if you are appealing a denial of benefits by the Veterans Health Administration (VHA).';
...
const hearingType3 =
  'Virtual Telehearing (I will attend using an internet-connected device)';
...
const additionalIssueOption = [
  {
    option:
      "Check here if you attached additional sheets. Include the Veteran's last name and the file number.",
    isSelected: false,
  },
];
          ...
          return (
            ...
            >
              ...
              <Form>
                ...
                <>
                  <p className="mb-5 mt-3 text-sm leading-relaxed text-gray-700 dark:text-white-light">
                    A Veterans Law Judge will consider your appeal in the order
                    in which it is received, depending on which of the following
                    review options you select.{' '}
                    <span className="italic">
                      (For additional explanation of your options, please see
                      the attached information and instructions.)
                    </span>
                  </p>
                ...
                <>
                  <p className="mb-5 mt-3 text-sm leading-relaxed text-gray-700 dark:text-white-light">
                    Please list each issue decided by VA that you would like to
                    appeal. Please refer to your decision notice(s) for a list
                    of adjudicated issues. For each issue, please identify the
                    date of VA's decision and the area of disagreement{' '}
                    <span className="italic">
                      (e.g., service connection, disability evaluation, or
                ...
                <>
                  <p className="mt-3 text-left text-[14px] font-normal text-blue-600 dark:text-white-light ">
