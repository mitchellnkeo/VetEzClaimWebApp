  ...
  return (
    <FrontLayout title="Accessibility">
      ...
      <p className="mb-6 text-justify">
        Vet EZ Claim is licensed to You (End-User) by EZ Claim LLC, located and registered at 20 N Orange Ave Suite 1100, Orlando, FL 32801, USA, Orlando, Florida 32801, United States (<span className="font-bold">"Licensor"</span>), for use only under the terms of this License Agreement.
        <br /><br />
        ...
        <br /><br />
        The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. EZ Claim LLC, not the Services, is solely responsible for the Licensed Application and the content thereof.
        <br /><br />
        This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest <span className="underline">Apple Media Services Terms</span> and <span className="underline">Conditions</span> and <span className="underline">Google Play Terms of Service</span> (<span className="font-bold">"Usage Rules"</span>). EZ Claim LLC acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.
        <br /><br />
        Vet EZ Claim when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Vet EZ Claim is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS") or Google's operating system ("Android").
      </p>
      ...
      <p className="mb-6 text-justify">
        ...
        <br /><br />
        2.3 You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with EZ Claim LLC's prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.
        <br /><br />
        2.4 You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with EZ Claim LLC's prior written consent).
        <br /><br />
      ...
      <p className="mb-6 text-justify">
        4.1 EZ Claim LLC is not obligated, expressed or implied, to provide any maintenance, technical or other support for the Licensed Application.
        <br /><br />
        4.2 EZ Claim LLC and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.
      </p>
      ...
      <p className="mb-6 text-justify">
        ...
        <br /><br />
        9.2 No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of EZ Claim LLC's sphere of influence that affect the executability of the Licensed Application.
        <br /><br />
        9.3 You are required to inspect the Licensed Application immediately after installing it and notify EZ Claim LLC about issues discovered without delay by email provided in <span className="font-medium">Contact Information</span>. The defect report will be taken into consideration and further investigated if it has been emailed within a period of three (3) days after discovery.
        <br /><br />
        9.4 If we confirm that the Licensed Application is defective, EZ Claim LLC reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
        <br /><br />
      ...
      <p className="mb-6 text-justify">
        EZ Claim LLC and the End-User acknowledge that EZ Claim LLC, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User's possession and/or use of that Licensed Application, including, but not limited to:
      </p>
      <ul className="list-decimal pl-6 mb-6">
      ...
      <p className="mb-6 text-justify">
        The license is valid until terminated by EZ Claim LLC or by You. Your rights under this license will terminate automatically and without notice from EZ Claim LLC if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</h2>
      <p className="mb-6 text-justify">
        EZ Claim LLC represents and warrants that EZ Claim LLC will comply with applicable third-party terms of agreement when using Licensed Application.
        <br /><br />
      ...
      <p className="mb-6 text-justify">
        EZ Claim LLC and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, EZ Claim LLC, and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.
      </p>
      ...
      <p className="mb-6 text-justify">
        ...
        <br /><br />
        17.3 The Vet EZ Claim Application (App) is not associated with the Veterans Administration or any other federal agency. Vet EZ Claim makes no guarantee that the provided forms are the most current or up-to-date copies of the forms provided in the application. The User is responsible for ensuring that all information that the Veterans Administration or any other federal agency requires in the form is complete and valid. Any indications that Vet EZ Claim makes within the application that a specific item is "required" is merely illustrative in nature and is not a guarantee that such field is required, nor is a lack of indication for a field being required a guarantee that such field is not required.
      </p>
      </div>
