export const SideToggleIcon = ({ height, width, className }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const SideToggleCloseIcon = ({ height, width, className }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const ToggleThemeIcon = ({ height, width, className }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const DarkThemeIcon = ({ height, width, className }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const SystemThemeIcon = ({ height, width, className }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const SettingsIcon = ({ height, width, className }) => {
  return (
    <svg
...
export const LogoutIcon = ({ height, width, className }) => {
  return (
    <svg
...
export const BackIcon = ({ height, width, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const DotIcon = ({ height, width }) => {
  return (
    <>
      <svg
...
export const ChatIcon2 = ({ height, width }) => {
  return (
    <svg
...
export const CallIcon = ({ height, width }) => {
  return (
    <svg
      className="mx-auto mb-1"
      width={width}
...
export const NotificationIcon = ({ height, width }) => {
  return (
    <span className="relative m-auto text-center">
      <svg
        width="20"
        height="20"
        viewBox="0 0 24 24"
...
export const PushNotificationIcon = ({ height = 20, width = 20 }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const ContactsIcon = ({ height, width }) => {
  return (
    <svg
      className="mx-auto mb-1"
      width={width}
...
export const EmailIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const DobIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const EmojiIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const SentMsgIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const ThreeDotIcon = ({ height, width }) => {
  return (
    <svg
      className="rotate-90 opacity-70 hover:text-primary"
      width="20"
      height="20"
      viewBox="0 0 24 24"
      fill="none"
...
export const NavIcon = ({ height, width }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const MessagesIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const GreenLedIcon = ({ height, width }) => {
  return (
    <>
      <span className="absolute -top-[3px] inline-flex h-full w-full animate-ping rounded-full bg-success/50 opacity-75 ltr:-left-[3px] rtl:-right-[4px]"></span>
      <span className="relative inline-flex h-[6px] w-[6px] rounded-full bg-success"></span>
    </>
  );
};
export const NoDataIcon = ({ height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="40"
...
export const CutIcon = ({ height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const EditCircleIcon = ({ height, width }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const SettingIcon = ({ height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const TaxIcon = ({ height, width }) => {
  return (
    <svg
      width={24}
      height={24}
...
export const BulletIcon = ({ colorClass = 'fill-primary' }) => {
  return (
    <svg
      width={15}
      height={15}
...
export const GeoIcon = ({ colorClass = 'fill-primary' }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const StarIcon = ({ colorClass = 'fill-primary' }) => {
  return (
    <svg
      width={20}
      height={20}
...
export const CopyToClipBoardIcon = ({ height, width }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <g
          ...
          strokeWidth="1.5"
        >
          <path d="M15 17v3a1 1 0 01-1 1H4a1 1 0 01-1-1V8a1 1 0 011-1h3"></path>
          <rect
            width="12"
            height="14"
            x="7"
...
export const TickIcon = ({ height, width }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const TelIcon = ({ height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
export const ClockIcon = ({ height, width }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const ComplaintIcon = ({ height = 24, width = 24 }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const ChatIcon = ({ height, width }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const AccountUpdateIcon = ({ height, width }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const ChangePasswordIcon = ({ height, width }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const EyeOpenIcon = ({ height, width }) => {
  return (
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const EyeCloseIcon = ({ height, width }) => {
  return (
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ReloadIcon = ({ height, width }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M13.707 1.293a1 1 0 010 1.414L12.405 4.01A9 9 0 113 13a1 1 0 112 0 7 7 0 107.427-6.987l1.28 1.28a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z"
          clipRule="evenodd"
        ></path>
      </svg>
    </>
...
export const DashboardIcon1 = ({
  ...
  return (
    <>
      <svg
        className={`group-hover:!text-primary ${className}`}
        width={width}
        height={height}
        viewBox="0 0 24 24"
        fill="#fff"
...
export const FormBuilderIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0.0693501 4.00839C0 4.37595 0 4.81722 0 5.69975V12.75C0 16.5212 0 18.4069 1.17157 19.5784C2.34315 20.75 4.22876 20.75 8 20.75H12C15.7712 20.75 17.6569 20.75 18.8284 19.5784C20 18.4069 20 16.5212 20 12.75V10.5479C20 7.91554 20 6.59935 19.2305 5.74383C19.1598 5.66514 19.0849 5.59024 19.0062 5.51946C18.1506 4.75 16.8345 4.75 14.2021 4.75H13.8284C12.6747 4.75 12.0979 4.75 11.5604 4.59678C11.2651 4.5126 10.9804 4.39471 10.7121 4.24543C10.2237 3.97367 9.81578 3.56578 9 2.75L8.44975 2.19975C8.17633 1.92633 8.03961 1.78961 7.89594 1.67051C7.27652 1.15704 6.51665 0.842286 5.71557 0.767375C5.52976 0.75 5.33642 0.75 4.94975 0.75C4.06722 0.75 3.62595 0.75 3.25839 0.81935C1.64031 1.12464 0.37464 2.39031 0.0693501 4.00839ZM10 10C10.4142 10 10.75 10.3358 10.75 10.75V12H12C12.4142 12 12.75 12.3358 12.75 12.75C12.75 13.1642 12.4142 13.5 12 13.5H10.75V14.75C10.75 15.1642 10.4142 15.5 10 15.5C9.58579 15.5 9.25 15.1642 9.25 14.75V13.5H8C7.58579 13.5 7.25 13.1642 7.25 12.75C7.25 12.3358 7.58579 12 8 12H9.25V10.75C9.25 10.3358 9.58579 10 10 10Z"
          fill="#1C274C"
        />
      </svg>
    </>
...
export const RoleIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const FunctionIcon = ({ height = '24', width = '24' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Countries = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Order = ({ height = '24', width = '24' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Transaction = ({ height = '24', width = '24' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Invoice = ({ height = '24', width = '24' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const State = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const StateIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          d="M2 5.25732C2 3.45835 3.567 2 5.5 2C7.433 2 9 3.45835 9 5.25732C9 7.04219 7.88292 9.12496 6.14003 9.86978C5.73374 10.0434 5.26626 10.0434 4.85997 9.86978C3.11708 9.12496 2 7.04219 2 5.25732Z"
          stroke="#1C274C"
          strokeWidth="1.5"
        />
        <path
          d="M15 17.2573C15 15.4584 16.567 14 18.5 14C20.433 14 22 15.4584 22 17.2573C22 19.0422 20.8829 21.125 19.14 21.8698C18.7337 22.0434 18.2663 22.0434 17.86 21.8698C16.1171 21.125 15 19.0422 15 17.2573Z"
          stroke="#1C274C"
          strokeWidth="1.5"
        />
        <path
...
export const SystemLogIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Counties = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          d="M8.38729 5.07916C8.2258 4.8117 8.05626 4.56198 7.8878 4.3346C9.04232 3.49515 10.4633 3 12 3C13.32 3 14.5547 3.36536 15.6084 4.00047C15.5932 4.08959 15.5717 4.19054 15.5419 4.30292C15.4363 4.70203 15.2701 5.08295 15.1288 5.3053C15.0801 5.38197 14.8798 5.5778 14.5164 5.84854C14.3544 5.96924 14.1745 6.08008 13.9603 6.20811L13.886 6.25243C13.6985 6.36416 13.4839 6.49199 13.2771 6.63373C12.7891 6.96807 12.2809 7.41998 11.9391 8.15075C11.6919 8.67927 11.7089 9.19402 11.8182 9.60686C11.8539 9.74163 11.8735 9.87731 11.8738 9.99652C11.8739 10.0336 11.8594 10.0928 11.7766 10.1619C11.6876 10.2363 11.5622 10.2812 11.4495 10.28C10.3725 10.2678 9.52299 9.37575 9.3997 7.95271C9.306 6.8712 8.8641 5.86882 8.38729 5.07916Z"
          fill="#1C274C"
        />
        <path
...
export const Cities = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M20.5 6.5C20.5 5.09554 20.5 4.39331 20.1629 3.88886C20.017 3.67048 19.8295 3.48298 19.6111 3.33706C19.1699 3.04224 18.5774 3.00529 17.496 3.00066C17.5001 3.29206 17.5 3.59655 17.5 3.91051L17.5 4V5.25H18.5C18.9142 5.25 19.25 5.58579 19.25 6C19.25 6.41421 18.9142 6.75 18.5 6.75H17.5V8.25H18.5C18.9142 8.25 19.25 8.58579 19.25 9C19.25 9.41421 18.9142 9.75 18.5 9.75H17.5V11.25H18.5C18.9142 11.25 19.25 11.5858 19.25 12C19.25 12.4142 18.9142 12.75 18.5 12.75H17.5V19.25H16V4C16 2.11438 16 1.17157 15.4142 0.585786C14.8284 0 13.8856 0 12 0H10C8.11438 0 7.17157 0 6.58579 0.585786C6 1.17157 6 2.11438 6 4V19.25H4.5V12.75H3.5C3.08579 12.75 2.75 12.4142 2.75 12C2.75 11.5858 3.08579 11.25 3.5 11.25H4.5V9.75H3.5C3.08579 9.75 2.75 9.41421 2.75 9C2.75 8.58579 3.08579 8.25 3.5 8.25H4.5V6.75H3.5C3.08579 6.75 2.75 6.41421 2.75 6C2.75 5.58579 3.08579 5.25 3.5 5.25H4.5V4L4.49999 3.9105C4.49996 3.59655 4.49992 3.29206 4.50403 3.00066C3.42262 3.00529 2.83008 3.04224 2.38886 3.33706C2.17048 3.48298 1.98298 3.67048 1.83706 3.88886C1.5 4.39331 1.5 5.09554 1.5 6.5V19.25H1C0.585786 19.25 0.25 19.5858 0.25 20C0.25 20.4142 0.585786 20.75 1 20.75H21C21.4142 20.75 21.75 20.4142 21.75 20C21.75 19.5858 21.4142 19.25 21 19.25H20.5V6.5ZM11 2.25C11.4142 2.25 11.75 2.58579 11.75 3V4.25H13C13.4142 4.25 13.75 4.58579 13.75 5C13.75 5.41421 13.4142 5.75 13 5.75H11.75V7C11.75 7.41421 11.4142 7.75 11 7.75C10.5858 7.75 10.25 7.41421 10.25 7V5.75H9C8.58579 5.75 8.25 5.41421 8.25 5C8.25 4.58579 8.58579 4.25 9 4.25H10.25V3C10.25 2.58579 10.5858 2.25 11 2.25ZM8.25 10C8.25 9.58579 8.58579 9.25 9 9.25H13C13.4142 9.25 13.75 9.58579 13.75 10C13.75 10.4142 13.4142 10.75 13 10.75H9C8.58579 10.75 8.25 10.4142 8.25 10ZM8.25 13C8.25 12.5858 8.58579 12.25 9 12.25H13C13.4142 12.25 13.75 12.5858 13.75 13C13.75 13.4142 13.4142 13.75 13 13.75H9C8.58579 13.75 8.25 13.4142 8.25 13ZM11 16.25C11.4142 16.25 11.75 16.5858 11.75 17V19.25H10.25V17C10.25 16.5858 10.5858 16.25 11 16.25Z"
          fill="#1C274C"
        />
      </svg>
    </>
...
export const CityIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const UserManagementIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ProviderManagementIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <ellipse cx="10" cy="17" rx="7" ry="4" fill="#1C274C" />
        <path
...
export const CaseManagementIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          d="M1.46447 1.46447C0 2.92893 0 5.28595 0 10C0 10.8185 0 11.5659 0.00766581 12.25H3L3.10773 12.2499C3.63376 12.2491 4.10075 12.2483 4.52918 12.4319C4.9576 12.6155 5.27913 12.9542 5.64131 13.3357L5.71552 13.4138L6.85712 14.6125C6.93865 14.6981 7.00536 14.7681 7.06418 14.8277C7.11449 14.7607 7.17125 14.6825 7.24061 14.5867L10.8944 9.54352C11.0432 9.33785 11.1985 9.12335 11.3518 8.96525C11.5272 8.78439 11.7992 8.57084 12.1937 8.55271C12.5882 8.53457 12.8787 8.72228 13.0699 8.88629C13.2371 9.02965 13.4114 9.229 13.5785 9.42014L15.3823 11.4816C15.868 12.0368 15.9718 12.1316 16.085 12.183C16.1982 12.2343 16.3379 12.25 17.0756 12.25H19.9923C20 11.5659 20 10.8185 20 10C20 5.28595 20 2.92893 18.5355 1.46447C17.0711 0 14.714 0 10 0C5.28595 0 2.92893 0 1.46447 1.46447Z"
          fill="#1C274C"
        />
        <path
          d="M19.9563 13.75H17.0756L16.9615 13.7501C16.4059 13.751 15.9125 13.7519 15.4652 13.5489C15.0179 13.346 14.6936 12.9741 14.3285 12.5553L14.2534 12.4694L12.4761 10.4382C12.395 10.3454 12.3284 10.2694 12.2697 10.2046C12.2171 10.2746 12.1578 10.3563 12.0855 10.4561L8.43239 15.4984C8.28939 15.696 8.13915 15.9035 7.99032 16.0574C7.8191 16.2345 7.55618 16.4416 7.17422 16.4672C6.79226 16.4929 6.50402 16.3227 6.31067 16.1701C6.1426 16.0375 5.96597 15.8519 5.79786 15.6753L4.62931 14.4483C4.14838 13.9433 4.04684 13.8572 3.9383 13.8106C3.82976 13.7641 3.69734 13.75 3 13.75H0.0437042C0.140899 16.0904 0.454249 17.5253 1.46447 18.5355C2.92893 20 5.28595 20 10 20C14.714 20 17.0711 20 18.5355 18.5355C19.5458 17.5253 19.8591 16.0904 19.9563 13.75Z"
          fill="#1C274C"
        />
      </svg>
    </>
...
export const CategoryIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ServiceIcon = ({ height = '18', width = '18' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ServiceMenuIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const AvailabilityIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const SystemIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const ReportIcon = ({ height = '20', width = '20' }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
