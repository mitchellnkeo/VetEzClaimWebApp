            ...
            <div className="flex items-center">
              ...
              <span className="text-white ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                ...
                {title === 'Support Request' ? (
                  <span
                    className={`badge my-0  text-white ltr:ml-4 rtl:mr-4 ${
                      supportWaitingCount == 0
                        ? 'opacity-0'
                        : 'opacity-1 bg-red-500'
                    } `}
                  >
                    {supportWaitingCount}
                  </span>
                ...
                <>
                  <li className="menu nav-item">
                    <button
                      ...
                      className={`${
                        errorSubMenu ? 'open' : ''
                      } w-full before:h-[5px] before:w-[5px] before:rounded before:bg-gray-300 hover:text-gray-100 ltr:before:mr-2 rtl:before:ml-2 dark:text-[#888ea8] dark:hover:text-gray-900`}
                      onClick={() => setErrorSubMenu(!errorSubMenu)}
                    >
                      {t(deepMenuTitle ? deepMenuTitle : null)}
                      <div
                        className={`${
